int speak_pin = D3;
char music[] = "ddrdfm ddrdsf ";// 依照簡譜的順序，填入代表的音符，空白代表休止符
unsigned long beats[] = {1,1,2,2,2,4,1,1,1,2,2,2,4,1};// 決定每個音階的拍子
char tones[]= { 'd', 'r', 'm', 'f', 's'}; // 音符字元
int fq[] = { 261, 294, 330, 349, 392}; // 音符對應的頻率
// d [261] Do 開頭音
// r [294] Re 每級上升約 +30Hz
// m [330] Mi 像 3 開頭
// f [349] Fa 比 MI 再高一點
...
void loop() {
  ...
  for (int i = 0; i < (int)sizeof(music)-1; i++) {
