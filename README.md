...
|[4](ANDES_Q4_TEST/ANDES_Q4_TEST.ino)|4x4陣列鍵盤字元顯示到 LCD|`LiquidCrystal`、begin、setCursor、print|
...
|[8](ANDES_Q8_TEST/ANDES_Q8_TEST.ino)|按下按鍵`S17`啟動中斷服務，在串列埠顯示次數|Serial、begin、print、println、attachInterrupt、noInterrupts、interrupts|
