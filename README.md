...
### 心得
- *2025/05/24* 考試
- 先考筆試(占30%) 20 題在 30 分鐘內寫完就好，考前要背題庫。實作題(占70%)有四大題，每大題約二到三小題。
> 我用的考場電腦不好，寫到後面可能程式碼大的原因，IDE 有時會 LAG 不會動，也無法用工作管理員關閉，我只好重開機，總共三次，還好還能存檔。最後，我實作剩10分鐘結束，有全正確做完。
- 考題(憑印象寫的)
  1. LED0-10 來回亮、LED7 LED8 往外亮到底再回來一次、一直重複 LED7 LED8 往外亮。
  2. 鍵盤 BT1-4 對應 `1 2 3 4`、`8`字左移、每按 BT1-4 會顯示在 7 段顯示器的最右邊，原來的會往左邊移，而原本最左邊的會消失。
  3. lcd 顯示 2025/5/24/1x/x/x 即時時間，按下鍵盤可以顯示鍵盤上對應的字元。
  4. 音樂播放 6 個音，後每個音比它前一個多一秒、撥放小星星音樂、鍵盤陣列1-8 按下可以對應 Do Re Mi... 
